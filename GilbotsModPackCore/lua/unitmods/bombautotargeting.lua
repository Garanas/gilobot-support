--#****************************************************************************
--#**
--#**  New File :  /mods/GilbotsModPackCore/lua/unitmods/bombautotargeting.lua
--#**  
--#**  Author   :  Gilbot-X
--#**
--#**  Summary  :  Used by crawling bomb for their charge ability
--#**
--#****************************************************************************
...
local resultClass = Class(baseClassArg) {
    ...
    DoStatValueUpdateFunction = function(self, statType, newStatValue)
        if statType == "ChargingRange" then 
