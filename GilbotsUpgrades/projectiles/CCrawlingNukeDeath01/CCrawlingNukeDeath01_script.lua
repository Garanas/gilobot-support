--#****************************************************************************
--#**
--#**  File     :  /mods/GilbotsUpgrades/projectiles/ccrawlingnukedeath01/ccrawlingnukedeath01_script.lua
--#**  Author(s):  Gilbot-X
--#**
...
CrawlingNukeDeath01 = Class(NullShell) {
    ...
    CreateOuterRingWaveSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            local proj =  self:CreateProjectile('/mods/GilbotsUpgrades/projectiles/ccrawlingnukedeathshockwave01/ccrawlingnukedeathshockwave01_proj.bp', X * OffsetMod , 2, Z * OffsetMod, X, 0, Z)
