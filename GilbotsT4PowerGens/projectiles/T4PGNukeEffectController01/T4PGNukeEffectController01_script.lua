--#****************************************************************************
--#**
--#**  From     :  /effects/Entities/UEFNukeEffectController01/UEFNukeEffectController01_script.lua
...
local ProjectileFolderPath = '/mods/gilbotst4powergens/projectiles/'

T4PGNukeEffectController01 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        CreateLightParticle(self, -1, army, 15, 4, 'glow_02', 'ramp_red_02')
        WaitSeconds(0.25)
        CreateLightParticle(self, -1, army, 30, 20, 'glow_03', 'ramp_fire_06')
        
        --# Create initial fireball dome effect
        local FireballDomeYOffset = -5
        self:CreateProjectile(ProjectileFolderPath .. 'T4PGNukeEffect01/T4PGNukeEffect01_proj.bp',0,FireballDomeYOffset,0,0,0,1)
        
        --# Create projectile that controls plume effects
        local PlumeEffectYOffset = 1
        self:CreateProjectile(ProjectileFolderPath .. 'T4PGNukeEffect02/T4PGNukeEffect02_proj.bp',0,PlumeEffectYOffset,0,0,0,1)        
        ...
        CreateLightParticle(self, -1, army, 30, 250, 'glow_03', 'ramp_nuke_04')
...
TypeClass = T4PGNukeEffectController01
