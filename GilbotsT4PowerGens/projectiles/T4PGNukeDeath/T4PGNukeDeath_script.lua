--#****************************************************************************
--#**
--#**  File     :  /mods/cybrancrawlingbombs/projectiles/ccrawlingnukedeath01/ccrawlingnukedeath01_script.lua
--#**  Author(s):  Gilbot-X
--#**
--#**  Summary  :  Crawling Nuke Death Explosion
--#**
--#****************************************************************************
...
T4PGNukeDeath = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        WaitSeconds( 0.25 )
        CreateLightParticle(self, -1, army, 20, 20, 'glow_03', 'ramp_fire_06')
        WaitSeconds( 0.55 )
    ...
    CreateOuterRingWaveSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            local proj =  self:CreateProjectile('/mods/gilbotst4powergens/projectiles/t4pgnukedeathshockwave/t4pgnukedeathshockwave_proj.bp', X * OffsetMod , 2, Z * OffsetMod, X, 0, Z)
